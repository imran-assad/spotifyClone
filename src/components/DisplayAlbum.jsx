...
const DisplayAlbum = (album) => {
  ...
  console.log("albums data in display album are", albumsData);
  console.log("songs data are here", songsData);
  return albumData ? (
    <>
      <Navbar />
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            <img
              ...
              alt=""
            />
            <b className="px-2">Spotify</b>
            &bull; 1,346,378 likes &bull; <b>50 songs </b>
            about 2 hr 30 min
          </p>
        </div>
      </div>
